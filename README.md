...
- Die archivierten Ergebnisse befinden sich unter `results/runs/20260629T202543Z/`; der Environment-Snapshot liegt dort als `environment_snapshot.json` und `pip_freeze.txt`.
